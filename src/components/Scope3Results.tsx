    ...
    return (
        <div style={{ backgroundImage: "url('/images/3.jpg')", backgroundSize: "cover" }}>
            <div className='flex flex-col items-center justify-center w-full h-fit bg-white/50 font-bold'>
                <p className='text-3xl font-bold text-green-900'>Resultat de calcul du Scope 3</p>
                <div className='flex  items-center justify-center gap-5 p-5'>
                    ...
                    <ResultRow data={data.tunis} scope={3} city='Tunis' />
                    <ResultRow data={data.sfax} scope={3} city='Sfax' />
                    <ResultRow data={data.sousse} scope={3} city='Sousse' />
                </div>
                <div className='flex'>
                    <div className='flex flex-col items-center justify-center p-5'>
                        ...
                        <div className='flex'>
                            <p className='p-5 border w-48 text-center'>{total(data.tunis, 3)} kgCO2e</p>
                            <p className='p-5 border w-48 text-center'>{total(data.sousse, 3)} kgCO2e</p>
                            <p className='p-5 border w-48 text-center'>{total(data.sfax, 3)} kgCO2e</p>
                        </div>
                    </div>
                    <div className='p-5'>
                        <DonutChart fractions={partitions(total(data.tunis, 3), total(data.sfax, 3), total(data.sousse, 3))} />
                    </div>
                </div>
